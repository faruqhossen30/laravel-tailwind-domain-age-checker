            ...
            <div class="mt-12 grid items-center lg:grid-cols-2 gap-6 lg:gap-16">
                ...
                <div class="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-8 dark:border-neutral-700">
                    ...
                    <form>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="hs-firstname-contacts-1" id="hs-firstname-contacts-1"
                                        class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                        ...
                        <div class="mt-4 grid">
                            <button type="submit"
                                class="w-full text-gray-800 dark:text-gray-400   dark:bg-slate-800 py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-gray-200 dark:border-neutral-700  disabled:opacity-50 disabled:pointer-events-none">Send
                                inquiry</button>
                        </div>
                ...
                <div class="divide-y divide-gray-200 dark:divide-neutral-800">
                    ...
                    <div class="flex gap-x-7 py-6">
                        <svg class="flex-shrink-0 size-6 mt-1.5 text-gray-800 dark:text-neutral-200" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <div class="grow">
                            ...
                            <a class="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200"
                                href="#">
                                Contact support
                                <svg class="flex-shrink-0 size-2.5 transition ease-in-out group-hover:translate-x-1" width="16" height="16" viewBox="0 0 16 16" fill="none"
                    ...
                    <div class=" flex gap-x-7 py-6">
                        ...
                        <div class="grow">
                            ...
                            <a class="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200"
                                href="#">
                                Contact sales
                                <svg class="flex-shrink-0 size-2.5 transition ease-in-out group-hover:translate-x-1" width="16" height="16" viewBox="0 0 16 16"
